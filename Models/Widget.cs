    ...
    public class Widget : IWorkListItem
    {
        ...
        private PromotionResult PromoteToIntegrating()
        {
            ...
            if (promotionResult.Success)
                ...
                promotionResult.Message = String.Format("Failed to promote the widget to Integrating status because its current status prevented it.");
        ...
        private PromotionResult DemoteToCanceled()
        {
            ...
            {
                promotionResult.Success = false;
                promotionResult.Message = String.Format("Failed to promote the widget to Canceled status because its current status prevented it.");
            }
